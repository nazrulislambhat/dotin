		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">March 30, 2023 <span class="changelog-version">Lite Version 5.1.17</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Update : Button : Controller Improvement','tpebl').'</li>';					
							echo '<li>'.esc_html__('Update : Tab Tours : Tab Active In Mobile Responsive','tpebl').'</li>';							
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">March 30, 2023 <span class="changelog-version">Pro Version 5.1.7</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Compatibility : Elementor Free & Pro 3.12','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Accordion : Horizontal Controller Improvement','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Product Listing : Quickview Compatibility With Multiple widgets','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
