...
class ThePlus_Off_Canvas extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Popup Builder', 'theplus');
    }
    ...
    protected function register_controls() {
		...
		$this->add_control(
			'pageload',
			[
				'label' => esc_html__( 'On Page Load', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Enable', 'theplus' ),
				'label_off' => esc_html__( 'Disable', 'theplus' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'exit',
			[
				'label' => esc_html__( 'On Exit Inlet', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Enable', 'theplus' ),
				'label_off' => esc_html__( 'Disable', 'theplus' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'inactivity',
			[
				'label' => esc_html__( 'After Inactivity', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Enable', 'theplus' ),
				'label_off' => esc_html__( 'Disable', 'theplus' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'pageviews',
			[
				'label' => esc_html__( 'After X Page Views', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Enable', 'theplus' ),
				'label_off' => esc_html__( 'Disable', 'theplus' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'prevurl',
			[
				'label' => esc_html__( 'Arriving From Specific URL', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Enable', 'theplus' ),
				'label_off' => esc_html__( 'Disable', 'theplus' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'extraclick',
			[
				'label' => esc_html__( 'On Any Other Element\'s Click', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Enable', 'theplus' ),
				'label_off' => esc_html__( 'Disable', 'theplus' ),
				'return_value' => 'yes',
		...
		$this->add_control(
            'showTime',
            [
				'label'   => esc_html__( 'Show For Specific Time', 'theplus' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		...
		$this->add_control(
            'showRestricted',
            [
				'label'   => esc_html__( 'Show X Times per User', 'theplus' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
	 ...
	 protected function render() {
		...
		if($flag) {
			...
			$off_canvas ='<div class="plus-offcanvas-wrapper '.esc_attr($widget_uid).' '.esc_attr($animated_class).' '.esc_attr($show_scroll_window_offset).'" data-canvas-id="'.esc_attr($widget_uid).'" '.$data_attr.' '.$scroll_top_offset_value.' '.$animation_attr.' '.esc_attr($PVCStyle).'>';
				...
				$off_canvas .='<div class="plus-canvas-content-wrap '.esc_attr($popinoutaniclass).' '.esc_attr($popinanimation).' '.esc_attr($popoutanimation).' '.esc_attr($popupdirclass).' plus-'.esc_attr($content_id).' plus-'.esc_attr($content_open_direction).' plus-'.esc_attr($content_open_style).' '.esc_attr($display_scrolling_bar).'">';
