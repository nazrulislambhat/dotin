		...
		return array_merge(
		 ...
		 array(
				...
				array(
					...
					'desc' => sprintf(__('<a href="https://support.google.com/analytics/answer/1008080?hl=en" target="_blank" rel="noopener noreferrer">Generate Tracking Id</a>. Note : Keep this field empty, If you have already added Tracking Script on Website. ', 'theplus')),
					'default' => '',
				...
				array(
					...
					'desc' => sprintf(__('<a href="https://www.facebook.com/business/help/952192354843755" target="_blank" rel="noopener noreferrer">Generate Facebook Pixel Id</a>. Note : Keep this field empty, If you have already added Tracking Script on Website.', 'theplus')),
					'default' => '',
